...
class InstapackBuildWebpackPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.done.tapPromise('display-build-results', (stats) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.variables.serve) {
                if (outputPublicPath) {
                    this.putInjectionScripts(statsObject, outputPublicPath);
                }
                else {
...
`;
    ...
    putInjectionScripts(stats, outputPublicPath) {
        if (!stats.chunks) {
            Shout_1.Shout.error(new Error('instapack: Cannot create injection scripts due to undefined stats chunk!'));
            return;
        }
        for (const chunk of stats.chunks) {
            ...
            for (const file of chunk.files) {
                ...
                this.putInjectionScript(file, outputPublicPath).then(() => {
...
exports.InstapackBuildWebpackPlugin = InstapackBuildWebpackPlugin;
