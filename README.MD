...
- `umdLibraryMode` can be set to `true` to allow building a single [UMD](https://github.com/umdjs/umd) JS bundle (without `.dll.js` file). Use this option when developing a library package! (npm or Razor Class Library)
