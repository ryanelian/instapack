...
### I thought that you should not concatenate files because of HTTP/2?
...
- Alternatively, TypeScript allows writing JavaScript using features that do not exist yet in browsers, then compile them down to `es5`.
