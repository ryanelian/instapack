...
The [no-longer-maintained](https://github.com/mishoo/UglifyJS2/pull/2897) UglifyES has been dropped in favor of the hopefully-more-stable UglifyJS 3. This change imposes stricter build requirements:
