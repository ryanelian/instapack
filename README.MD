...
As testament of TypeScript effectiveness, `instapack` is fully written using TypeScript!
...
```js
require('./a');         // client/a.js
require('./b');         // client/b.js
require('./folder/c');  // client/folder/c.js
