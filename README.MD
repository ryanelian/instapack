...
Modules imported from `node_modules` will now be extracted automatically to `[jsOut]_modules.js`, for example: `ipack_modules.js`: **this file must be included using `<script>` tag BEFORE the main app file `ipack.js`**
