...
In fact, you can just add the packages required and start hacking. We'll take care of the outputs. We have also enabled `tsx` compilation specifically for React.
