...
> `resolveJsonModule` compiler option requires TypeScript 2.9.0 / instapack 6.5.0 or above. Earlier versions supports importing JSON files using `require` syntax instead.
