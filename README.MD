...
Refactor the root component as a *hot-exported* module:
...
export const App = () => <Hello compiler="instapack" framework="React" />;
...
Then add `alias` field to instapack settings in `package.json`
