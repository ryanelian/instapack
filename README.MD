...
**However, Your lint errors will not be visible in Visual Studio Code...** To remedy this issue, use the following special ESLint configuration instead: (Add two more packages:)
