...
- `umdLibraryMode` allows building a single [UMD](https://github.com/umdjs/umd) JS bundle (without `.dll.js` file). This configuration should be used when building a library package.
