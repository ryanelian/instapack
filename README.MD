...
TypeScript project targeting `es5` is supported, which guarantees the JS output to be [runnable on browsers as early as Internet Explorer 9](http://kangax.github.io/compat-table/es5/) when armed with [polyfills](https://www.npmjs.com/package/ts-polyfill). (That said, you are advised NOT to develop solutions for [obsoleted browsers](https://www.microsoft.com/en-us/windowsforbusiness/end-of-ie-support)!)
...
- `react` for developing a web app using [React](https://reactjs.org/) and [MobX](https://github.com/mobxjs/mobx) and [Semantic UI](https://semantic-ui.com/).
...
- (PREVIEW) `angular` for developing a web app using [the new Angular](https://angular.io/) and [Material Design](https://material.angular.io/). (Warnings: [1](https://github.com/angular/angular/issues/11580) [2](https://github.com/angular/angular/issues/21560))
...
```
[17:14:25] Hot Reload Server running on ports: 22001, 22002
[17:14:25] Compiling index.ts > ES5 in C:/VS/MyWebApp/client/js/
[17:14:26] ipack.dll.js 5.00 MB in http://localhost:22001/js/
[17:14:26] ipack.js 58.0 kB in http://localhost:22001/js/
[17:14:26] +wormhole: C:/VS/MyWebApp/wwwroot/js/ipack.dll.js --> http://localhost:22001/js/ipack.dll.js
[17:14:26] +wormhole: C:/VS/MyWebApp/wwwroot/js/ipack.js --> http://localhost:22001/js/ipack.js
[17:14:26] Finished JS build after 1.22 s
```
...
> **DEPRECATION NOTICE:** a special extension `.vue.html` module will be compiled to [an `IVueCompiledTemplate` object to be used as parameters for Vue.js `ComponentOptions`](https://vuejs.org/v2/guide/render-function.html#Template-Compilation). This behavior will be removed in future instapack versions.
...
declare module "*.vue.html" {
    ...
    interface IVueCompiledTemplate
    {
      render: (createElement: CreateElement) => VNode,
      staticRenderFns: ((createElement: CreateElement) => VNode)[]
    }

    const _: IVueCompiledTemplate;
    export default _;
}
```
...
import MyComponentTemplate from './MyComponent.vue.html';

@Component({
    render: MyComponentTemplate.render,
    staticRenderFns: MyComponentTemplate.staticRenderFns
})
