...
- `hyperapp` when you want to develop a web app with [hyperapp](https://github.com/hyperapp/hyperapp). (1kB, with state management)
...
- Include files relative to the source in a named folder, but as `index.scss` or `_index.scss` ([Standard Sass behavior](https://github.com/sass/sass/issues/690)) or `index.css` or `_index.css`
