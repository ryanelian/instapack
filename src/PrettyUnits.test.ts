...
test('SI Degree: 500', t => {
    const x = siDegree(500);
    t.is(x, 0);
});

test('SI Degree: 5000', t => {
    const x = siDegree(5000);
    t.is(x, 1);
});

test('SI Degree: 500500', t => {
    const x = siDegree(500500);
    t.is(x, 1);
});

test('SI Degree: 5000500', t => {
    const x = siDegree(5000500);
    t.is(x, 2);
});
